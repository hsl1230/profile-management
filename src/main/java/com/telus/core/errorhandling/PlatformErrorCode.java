...
public enum PlatformErrorCode implements ErrorCode {
	...
	REQUEST_NOT_PARSABLE("5023", "Request body not parsable", "The request is not parsable."),
	REQUEST_PARAM_MISSING("5024", "Missing request parameter(s)", "The request is missing at least one parameter."),
